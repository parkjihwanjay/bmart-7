...
// async function insertProducts(parent, args, context: Context) {
...
//   categories.forEach(async (mainCategory) => {
//     const main = await context.prisma.mainCategory.findMany({
//       where: {
//         title: mainCategory.name,
//       },
//     })

//     mainCategory.sub.forEach(async (category) => {
...
//       const splitedMainImage = product.mainImage.split('/')
//       const splitedBannerImage = product.bannerImage.split('/')
...
//           isMain: product.isMain ? 1 : 0,
//           description: product.description,
//           mainImage: splitedMainImage[splitedMainImage.length - 1],
//           bannerImage: splitedBannerImage[splitedBannerImage.length - 1],
//         },
//       })
//     })
//   })
